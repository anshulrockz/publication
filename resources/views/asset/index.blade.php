                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:115px">
                                    <!-- <a href="{{ url('/assets/new/'.$list->id)}}" class="btn btn-xs btn-success"> View </a> -->
                                    <a href="{{ url('/assets/old/'.$list->id.'/edit')}}" class="btn btn-xs btn-info"> <i class="material-icons">edit</i> </a>
                                    <form style="display: inline;" method="post" action="{{route('old.destroy',$list->id)}}">
				                        {{ csrf_field() }}
				                        {{ method_field('DELETE') }}
