    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a class="btn btn-primary waves-effect header-dropdown m-r--5" href="{{ url('/purchase/create')}}">Add New</a>
            </div>
            <div class="body">
                <div class="">
                    <table class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <a href="{{ url('/purchase/'.$list->id)}}" class="btn btn-xs btn-success"> View </a> -->
                                    @if($list->status==1)
                                    <a href="{{ url('/purchase/'.$list->id.'/edit')}}" class="btn btn-xs btn-info"> <i class="material-icons">edit</i> </a>
        	                		...
        	                		@endphp
        	                		@if($days<1)
                                    <a href="{{ url('/purchase/cancel/'.$list->id)}}" class="btn btn-xs btn-warning"> <i class="material-icons">cancel</i> </a>
                                    @endif
                                    @endif
                                    @if(Auth::id()==1)
                                    <form style="display: inline;" method="post" action="{{route('Purchases.destroy',$list->id)}}">
				                        {{ csrf_field() }}
				                        {{ method_field('DELETE') }}
