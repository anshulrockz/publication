...
$(document).ready(function() {
    ...
    if($("#asset_category option:selected").text() != 'Vehicle') $('.vehicle').hide();
                ...
                <form id="form" method="post" action="{{route('new.update',$asset->id)}}" enctype="multipart/form-data">
                	...
                	<div class="row clearfix">
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        ...
			                        <!-- <select class="form-control show-tick" id="asset_category" name="asset_category" required>
			                            ...
			                            <option value="{{$list->id}}" @if($list->name == $asset->main_category) selected @endif >{{$list->name}}</option>
			                            @endforeach
			                        </select> -->
		                    	</div>
	                    	</div>
                	 ...
                	 <div class="row clearfix pannel-hide">
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        <select class="form-control show-tick" id="location" name="location">
			                            ...
			                            <option value="{{$list->id}}" @if($list->id == $asset->location) selected @endif >{{$list->name}}</option>
			                            @endforeach
			                        </select>
		                    	</div>
	                    	</div>
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <select class="form-control show-tick" id="mfg" name="mfg">
			                            ...
			                            <option value="{{$list}}" @if($list == $asset->mfg) selected @endif > {{ $list }} </option>
			                            @endforeach
			                        </select>
		                        </div>
		                    </div>
	                	...
	                	<div class="col-sm-6 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="hsn_code" name="hsn_code" class="form-control" placeholder="Enter hsn_code no" value="{{ $asset->hsn_code }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <!-- <div class="col-sm-6 ">
	                ...
	                <div class="row clearfix pannel-hide">
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="number" id="amount" name="amount" class="form-control " placeholder="Enter cost" value="{{ $asset->amount }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <select class="form-control show-tick" id="tax" name="tax" >
		                            ...
		                            @foreach($tax as $list)
		                            <option value="{{$list->value}}" @if($list->value == $asset->tax) selected @endif > {{ $list->value }} </option>
		                            @endforeach
		                        </select>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="total_tax" name="total_tax" class="form-control " value="{{ $asset->total_tax }}" >
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-3 ">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="total_amount" name="total_amount" class="form-control " value="{{ $asset->total_amount }}" >
		                        </div>
		                    </div>
	                    </div>
	                </div>
