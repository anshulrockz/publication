                ...
                <form method="post" action="{{route('employees.store')}}">
	                ...
	                <div class="row clearfix">
	                    ...
	                    <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="email" name="email" class="form-control" placeholder="Enter an unique email id" value="{{ old('email') }}">
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="dob" name="dob" class="form-control datepicker" placeholder="Enter Date Of Birth" value="{{ old('dob') }}">
		                        </div>
		                    </div>
	                    </div>
	                </div>
