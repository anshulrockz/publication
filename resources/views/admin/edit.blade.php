                ...
                <form method="post" action="{{route('users.store')}}" autocomplete="off">
	                ...
	                <div class="row clearfix">
	                    ...
	                    <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="phone" name="phone" class="form-control" placeholder="Enter phone number" value="{{ $users->phone }}">
		                        </div>
		                    </div>
	                    </div>
	                    <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input autocomplete="off" type="text" id="email" name="email" class="form-control" placeholder="Enter an unique email id" value="{{ $users->email }}" required>
		                        </div>
		                    </div>
	                    </div>
	                ...
	                <div class="row clearfix">
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        <select class="form-control show-tick" id="employee_type" name="employee_type" required>
			                            ...
			                            <option value="{{$list1->id}}" @if($list1->id==$users->user_type){ selected="selected" } @endif >{{$list1->name}}</option>
			                            @endforeach
			                        </select>
		                    	</div>
	                    	</div>
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        <select class="form-control show-tick" id="designation" name="designation" required>
			                            ...
			                            <option value="{{$list1->id}}" @if($list1->id==$users->designation){ selected="selected" } @endif >{{$list1->name}}</option>
			                            @endforeach
			                        </select>
		                    	</div>
	                    	</div>
		                    ...
		                    <div class="form-group">
			                    <div class="form-line">
			                        <select class="form-control show-tick" id="department" name="department" required>
			                            ...
			                            <option value="{{$list1->id}}" @if($list1->id==$users->department_id) selected="selected" @endif >{{$list1->name}}</option>
			                            @endforeach
			                        </select>
		                    	</div>
	                    	</div>
	                    ...
	                    <div class="col-sm-6">
		                    	<label for="hod">Are You HOD?</label>
	                			<input type="checkbox" id="hod" name="hod" value="1" class="filled-in" style="opacity:1;left:25%" @if($users->hod==1) checked @endif  />
	                	</div>
	                    <div class="col-sm-12">
		                    <label for="address">Address</label>
		                    <div class="form-group">
		                        <div class="form-line">
		                            <textarea id="address" name="address" rows="1" class="form-control no-resize auto-growth" placeholder="Enter address of person(press ENTER for more lines)" required>{{ $users->address }}</textarea>
		                        </div>
		                    </div>
	                    </div>
                    </div>
