        ...
        <div class="card">
            ...
            <div class="body">
                <ol class="breadcrumb breadcrumb-bg-pink">
                    ...
                    <li class="active">Claim Sub Category</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <a class="btn btn-primary waves-effect header-dropdown m-r--5" href="{{ url('sub-claim-categories/create')}}">Create New</a>
            </div>
            <div class="body">
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/sub-claim-categories/'.$list->id.'/edit')}}" class="btn btn-xs btn-info"> <i class="material-icons">edit</i> </a>
                                    <form style="display: inline;" method="post" action="{{route('sub-claim-categories.destroy',$list->id)}}">
				                        {{ csrf_field() }}
				                        {{ method_field('DELETE') }}
                                    ...
                                    <a href="{{ url('/sub-claim-categories/'.$list->id)}}" class="btn btn-xs btn-default" title="Add Sub Category"> <i class="material-icons">low_priority</i> </a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
